...
public class ChildActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intentThatStartedAThisActivity = getIntent();
        // TODO (4) Create an if statement to check if this Intent has the extra we passed from MainActivity
        if (intentThatStartedAThisActivity.hasExtra(Intent.EXTRA_TEXT)) {
            // TODO (5) If the Intent contains the correct extra, retrieve the text
            String textEntered = intentThatStartedAThisActivity.getStringExtra(Intent.EXTRA_TEXT);
